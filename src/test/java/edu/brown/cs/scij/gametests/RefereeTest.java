...
public class RefereeTest {
	...
	public void roadScoringTest() throws InvalidEdgeException{
		...
		assertTrue(r.scoreRoad("something which indicates road on roadThrough") == 3);
		r = new Referee();
		...
		roadThrough.placeMeeple(p, );
		assertTrue(r.scoreRoad("something which indicates road on roadThrough") == 6);
		horizRoad.placeMeeple(p, );
		assertTrue(r.scoreRoad("something which indicates road on horizRoad") == 6);
