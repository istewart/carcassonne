...
public class RefereeTest {
  ...
  @Test
  public void validMeepleRoadTest() throws InvalidEdgeException, PosnTakenException, NullTileException {
	  Center c = new Center(Feature.ENDPOINT);
	  Edge road = new Edge(Feature.ROAD);
	  Edge road2 = new Edge(Feature.ROAD);
	  Edge road3 = new Edge(Feature.ROAD);
  ...
  @Test
  public void validMeepleAfterPlaceTest() throws InvalidEdgeException, PosnTakenException, NullTileException, OutOfMeeplesException, UnMeeplableException {
	  Center c = new Center(Feature.CITY);
	  Edge city = new Edge(Feature.CITY);
	  Edge city2 = new Edge(Feature.CITY);
	  Edge city3 = new Edge(Feature.CITY);
  ...
  @Test
  public void validMeepleCurvedRoadTest() throws InvalidEdgeException, PosnTakenException, NullTileException, OutOfMeeplesException, UnMeeplableException {
	  Center c = new Center(Feature.ROAD);
	  Edge road = new Edge(Feature.ROAD);
	  Edge road2 = new Edge(Feature.ROAD);
	  Edge field = new Edge(Feature.FIELD);
	  Tile t = new Tile(c, road, road2, field, field, 0);
	  Posn p = new Posn(0,0);
	  Player p1 = new Player(1, "p1");
	  List<Player> players = new ArrayList<>();
	  players.add(p1);
  ...
  @Test
  public void validMeepleLongRoadTest() throws InvalidEdgeException, PosnTakenException, NullTileException, OutOfMeeplesException, UnMeeplableException {
	  Center c = new Center(Feature.ENDPOINT);
	  Edge road = new Edge(Feature.ROAD);
	  Edge field = new Edge(Feature.FIELD);
	  ...
	  r.place(centerP, center);
	  List<Direction> directions = r.validMeeples(centerP);
	  assertTrue(directions.size() == 0);
  }
}
