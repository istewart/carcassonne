...
public class CenterTest {
  ...
  @Test
  public void setCopyFunctionality() {
    Set<Posn> posns = new HashSet<>();
    posns.add(new Posn(0, 0));
    Set<Posn> otherPosns = new HashSet<>(posns);
    otherPosns.remove(new Posn(0, 0));
    assertTrue(posns.size() == 1);
    assertTrue(otherPosns.size() == 0);
  }
}
